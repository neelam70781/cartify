...
function Row({ item, index }) {
    ...
    return (
        <tr>
            ...
            <td className="border-y bg-white px-3 py-2">
                <div className="flex">
                    <h3 className="bg-blue-100 text-blue-500 text-xs rounded-full px-2 py-1 uppercase">
                        {item?.paymentMode}
                    </h3>
                </div>
            </td>
            <td className="border-y bg-white px-3 py-2">
                <div className="flex">
                    <h3 className="bg-green-100 text-green-500 text-xs rounded-full px-2 py-1 uppercase">
                        {item?.status ?? "pending"}
                    </h3>
                </div>
            </td>
            <td className="border-y bg-white px-3 py-2 border-r rounded-r-lg">
                <div className="flex">
                    <Link href={`/admin/orders/${item?.id}`}>
                        <button className="bg-red-500 hover:bg-red-700 transition-all duration-200 text-white px-3 py-2 rounded-lg text-xs">
                            View
                        </button>
                    </Link>
                </div>
